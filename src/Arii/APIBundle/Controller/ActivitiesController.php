...
class ActivitiesController extends FOSRestController
{
    ...
    {
        $Activities = $this->getDoctrine()->getRepository('AriiJOBBundle:Job')->findAll();
        
        $data = $this->get('jms_serializer')->serialize($Activities, 'json', SerializationContext::create()->setGroups(array('list')));
