...
{
    public function getAction($repoId='ats_db', $outputFormat, Request $request)
    {
        ...
        $Calendars = $state->Calendar($em,$Filter);
    ...
    public function getDaysAction($repoId='ats_db', $calendarName, $outputFormat, Request $request)
    {
        $em = $this->getDoctrine()->getManager($repoId);        
