...
class ChainsController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('AriiJIDBundle:Scheduler\Chains:index.html.twig', [ 'db' =>$portal->getDatabase() ]);
    }
    
    public function menuAction()
    {
        return $this->render('AriiJIDBundle:Scheduler\Chains:menu.xml.twig');
    }
