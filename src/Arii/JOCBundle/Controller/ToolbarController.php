...
class ToolbarController extends Controller
{
    public function globalAction()
    {
        ...
        return $this->render('AriiJOCBundle:Toolbar:global.xml.twig', array( 'refresh' => $refresh, 'refDate' => $refDate, 'database' => $database, 'databases' => $databases, 'filter' => $filter, 'filters' => $filters ), $response );
    }
