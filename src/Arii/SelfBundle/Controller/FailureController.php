...
class FailureController extends Controller
{
    ...
    {
        return $this->render('AriiSelfBundle:Failure:index.html.twig');
    }
    ...
    public function menuAction()
    {
        ...
        return $this->render('AriiSelfBundle:Failure:menu.xml.twig',[], $response);
    }
    ...
    public function gridAction()
    {
        ...
        $Requests = $this->getDoctrine()->getRepository("AriiSelfBundle:Request")->findByStatus('FAILURE');
