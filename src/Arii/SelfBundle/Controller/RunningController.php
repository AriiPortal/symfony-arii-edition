...
class RunningController extends Controller
{
    ...
    {
        return $this->render('AriiSelfBundle:Running:index.html.twig');
    }
    ...
    public function menuAction()
    {
        ...
        return $this->render('AriiSelfBundle:Running:menu.xml.twig',[], $response);
    }
    ...
    public function gridAction()
    {
        ...
        $Requests = $this->getDoctrine()->getRepository("AriiSelfBundle:Request")->findByStatus('RUNNING');
